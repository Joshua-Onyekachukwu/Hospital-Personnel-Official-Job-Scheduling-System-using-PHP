...
if (strlen($_SESSION['etmsaid']==0)) {
 ...
 $desc=$_POST['desc'];
 $eid=$_GET['editid'];
$sql="update tblpersonel set DepartmentID=:deptname,EmpId=:empid,EmpName=:empname,EmpEmail=:empemail,EmpContactNumber=:empcontno,Designation=:designation,EmpDateofbirth=:empdob,EmpAddress=:empadd,EmpDateofjoining=:empdoj,Description=:desc where ID=:eid";
...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
  echo '<script>alert("personel detail has been updated")</script>';
}
...
<html lang="en">
   <head>
      <title>HOSPITAL PERSONEL OFFICIAL JOB SCHEDULING SYSTEM || Update personel</title>
                                          ...
                                          <div class="padding_infor_info">
                                             <div class="alert alert-primary" role="alert">
                                                <form method="post">
                                                   <?php
$eid=$_GET['editid'];
$sql="SELECT tbldepartment.ID as did, tbldepartment.DepartmentName,tblpersonel.ID as eid,tblpersonel.DepartmentID,tblpersonel.EmpName,tblpersonel.EmpId,tblpersonel.EmpEmail,tblpersonel.EmpContactNumber,tblpersonel.EmpDateofjoining,tblpersonel.Designation,tblpersonel.EmpDateofbirth,tblpersonel.EmpAddress,tblpersonel.Description,tblpersonel.ProfilePic,tblpersonel.CreationDate from tblpersonel join tbldepartment on tbldepartment.ID=tblpersonel.DepartmentID where tblpersonel.ID=:eid";
$query = $dbh -> prepare($sql);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
$query->execute();
...
<option value="<?php echo htmlentities($row2->ID);?>"><?php echo htmlentities($row2->DepartmentName
 ...
 <?php } ?>
                           ...
                           <div class="field">
                              <label class="label_field">Personel ID</label>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">Personel Name</label>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">Personel Email</label>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">Personel Contact Number</label>
                          ...
                          <br>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">PersonelAddress</label>
                           ...
                           <br>
                           <div class="field">
                              <label class="label_field">PersonelDate of Joining</label>
                           ...
                           <div class="field">
                              <label class="label_field">Personel Pic</label>
