...
if (strlen($_SESSION['etmsaid']==0)) {
 ...
 $tdesc=$_POST['tdesc'];
 $tedate=$_POST['tedate'];
$sql="insert into tblschedule(DeptID,AssignScheduleto,SchedulePriority,ScheduleTitle,ScheduleDescription,ScheduleEduedate)values(:deptid,:emplist,:tpriority,:ttitle,:tdesc,:tedate)";
...
<html lang="en">
   <head>
      <title>HOSPITAL PERSONEL OFFICIAL JOB SCHEDULING SYSTEM || Add schedule</title>
 ...
 <?php } ?>
                          ...
                          <div class="field">
                              ...
                              <select type="text" name="tpriority" value="" class="form-control" required='true'>
                                 <option value="">Select Schedule Priority</option>
