...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmpEmail FROM tblpersonel WHERE EmpEmail=:email and EmpContactNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblpersonel set Password=:newpassword where EmpEmail=:email and EmpContactNumber=:mobile";
...
<html lang="en">
   <head>
      ...
      <title>HOSPITAL PERSONEL OFFICIAL JOB SCHEDULING SYSTEM || Forgot Page</title>
