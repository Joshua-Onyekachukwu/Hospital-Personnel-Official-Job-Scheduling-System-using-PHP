...
(function ($, window, document, undefined) {
          ...
          set: {
            date: function (date, updateInput, fireChange) {
              ...
              if (!!endDate && !!date && date > endDate) {
                //selected date is greater than Due Date in range, so clear Due Date
          ...
          selectDate: function (date, forceSet) {
            ...
            if (complete) {
              ...
              if (!canceled && settings.closable) {
                module.popup('hide');
                //if this is a range calendar, show the Due Date calendar popup and focus the input
                var endModule = module.get.calendarModule(settings.endCalendar);
                if (endModule) {
  ...
  $.fn.calendar.settings = {
    ...
    endCalendar: null,    // jquery object or selector for another calendar that represents the Due Date of a date range
