...
$sql ="SELECT ID FROM tblpersonel WHERE ID=:empid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblpersonel set Password=:newpassword where ID=:empid";
...
<html lang="en">
   <head>
      <title>HOSPITAL PERSONEL OFFICIAL JOB SCHEDULING SYSTEM || Change Password</title>
