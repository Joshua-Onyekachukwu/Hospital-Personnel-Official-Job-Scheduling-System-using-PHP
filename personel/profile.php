...
if (strlen($_SESSION['etmsempid']==0)) {
 ...
 $empdoj=$_POST['empdoj'];
 $desc=$_POST['desc'];
  $sql="update tblpersonel set EmpName=:empname,Designation=:designation,EmpDateofbirth=:empdob,EmpAddress=:empadd,EmpDateofjoining=:empdoj,Description=:desc where ID=:eid";
...
<html lang="en">
   <head>
      <title>HOSPITAL PERSONEL OFFICIAL JOB SCHEDULING SYSTEM || Profile</title>
